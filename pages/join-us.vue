...
useHead({
  ...
  link: [
    {
      rel: 'canonical',
      href: `https://www.ambulanceservice.com.sg/join-us/`
    },
...
<template>
  <default-page>
    ...
    <div>
      ...
      <ol>
        <li>Free training and development programmes</li>
        <li>Competitive salaries and bonuses</li>
        <li>Drivers may drive ambulance home (subject to approval)</li>
